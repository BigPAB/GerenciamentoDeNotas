...
<body style="background-image:url(Ht.jpg)">
    ...
    <c:forEach items="${listaNotaAluno }" var="notaAluno">
    <tbody>
      
      <tr>
        
        <td>${notaAluno.value.matriculaAluno}</td>
      
      
        
        <td>${notaAluno.value.idMateria}</td>
      
      
        
        <td>${notaAluno.value.notaAv1}</td>
      
      
        
        <td>${notaAluno.value.notaAv2}</td>
      
      
        
        <td>${notaAluno.value.notaAv3}</td>
