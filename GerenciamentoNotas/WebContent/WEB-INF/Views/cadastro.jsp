		...
		<div class="panel panel-default">
				...
				<div class="panel-body">
					<form:form  action="salvarAluno" method="POST">
						...
						<div class="row padding-top-10">
							<div class="col-md-2 ">
								<form:label path="matricula" for="Matrícula" class="control-label">Matricula:</form:label>
								<form:input path="matricula" type="text" class="control-form" name="matricula" id="matricula" placeholder="Matrícula"/>
							</div>
						</div>	
						...
						<div class="row padding-top-10">
							<div class="col-md-2 ">
								...
								<form:input path="nomeMateria" type="text" class="control-form" name="materia" id="materia" placeholder="Matéria"/>
							</div>
						</div>
